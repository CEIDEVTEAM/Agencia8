  ...
  return (
    <div className={baseStyle} ref={ref} {...other}>
      ...
      <span className="flex items-center font-semibold tracking-wide uppercase">
        Mostrando registros {activePage * resultsPerPage - resultsPerPage + 1}-
        {Math.min.apply(this, [activePage * resultsPerPage, totalResults])} de {totalResults} --- CANTIDAD DE PAGINAS {TOTAL_PAGES}
      </span>
